...
export const OptionsNav: React.FunctionComponent<any> = ({ toggleCart, toggleSearch, toggleMenu }) =>{
    ...
    return (
        <nav className='una-header-options-nav'>
            ...
            <PedidosButton  className="desktop-only" onClick={()=>history.push("/cotacoes")}/>
